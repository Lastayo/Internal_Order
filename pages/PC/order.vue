            ...
            <div class="IOform flex-1 bg-white px-8 pt-6 overflow-hidden flex flex-col m-10 mx-12 rounded-2xl shadow-md">
                    ...
                    <div class="px-6 pt-4">
                        <div class="flex gap-8 flex-col lg:flex-row">
                            <div class="flex flex-col w-full relative">
                                ...
                                <input type="text" name="project_name" v-model="postData.project_name"
                                ...
                                <input type="text" name="iwo" v-model="postData.iwo"
                                ...
                                <input type="text" name="project_manager" v-model="postData.project_manager"
                                    class="mt-1 w-full pl-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm"
                                ...
                                <input type="text" name="customer" v-model="postData.customer"
                                    class="mt-1 w-full pl-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm "
                                ...
                                <input type="text" name="end_customer" v-model="postData.end_customer"
                                    class="mt-1 w-full pl-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm "
                            ...
                            <div class="flex flex-col w-full relative">
                                ...
                                <input type="text" name="bu_delivery" v-model="postData.bu_delivery"
                                ...
                                <input type="text" name="bu_related" v-model="postData.bu_related"
                                    class="mt-1 w-full pl-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm"
                                ...
                                <textarea name="project_description" v-model="postData.project_description"
                        ...
                        <div class="flex justify-end">
                            <button @click="submit_projectcharter(); nextStep()"
                ...
                <div v-if="currentStep === 2" class="">
                            ...
                            <div class="flex gap-8 flex-col lg:flex-row">
                                <div class="flex flex-col w-full relative">
                                    ...
                                    <div
                                        ...
                                        <label class="cursor-pointer ltr">
                                            ...
                                            <input type="file" @change="handleHighLevelRequirmentChange"
                                                style="display: none;">
                                        </label>
                                    </div>
                                    ...
                                    <textarea name="descriptions" v-model="postData.assumptions"
                                    ...
                                    <textarea name="constraints" v-model="postData.contraints"
                                ...
                                <div class="flex flex-col w-full relative">
                                    <div class="">
                                        ...
                                        <textarea name="descriptions" v-model="postData.risk"
                                            class="mt-1 w-full px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm" />

                                        <label class="block text-md font-medium text-slate-700 mb-1">
                                            Key Stakeholders
                                        </label>
                                        <input type="text" name="requester" v-model="postData.key_stakeholders"
                                            class="mt-1 w-full pl-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm "
                    ...
                    <div class="flex ">
                        ...
                        <div class="flex justify-end ml-auto">
                            <button @click="submit_description(); nextStep()"
                ...
                <div v-if="currentStep === 3">
                    ...
                    <div class="">
                        ...
                        <div class="flex justify-between items-end mt-4 px-6 mb-4">
                            ...
                            <button @click="submit_deliverable(); nextStep()"
                ...
                <div v-if="currentStep === 4">
                    ...
                    <div class="flex justify-between items-end mt-4 px-6 mb-4">
                        ...
                        <button @click="submit_milestone(); nextStep()"
                            class="ml-auto px-10 h-10 text-sm bg-[#C53030] text-white rounded-md">
                            Next
                        </button>
                    </div>
                ...
                <div v-if="currentStep === 5">
                        ...
                        <div class="flex space-x-8">
                            <div class="flex flex-col w-full relative">
                                ...
                                <div
                                    ...
                                    <label class="cursor-pointer ltr">
                                        <span class="text-gray-500 pe-2 fas fa-upload"></span>
                                        <input type="file" style="display: none;" @change="handleFileInputChange">
                                    </label>
                                </div>
                            </div>
                            <div class="flex flex-col w-full relative">
                        ...
                        <table class="min-w-full bg-white border-collapse rounded-md px-6">
                            ...
                            <tbody>
                                <tr v-for="(memberResponsiple, index) in paginatedMembersResponsiple" :key="index">
                                    ...
                                    <td class="py-1 px-6">
                                        <input v-model="memberResponsiple.nama_pc" type="text"
                                            class="text-center w-full pl-3 py-2 bg-white placeholder-slate-400 rounded-md sm:text-sm"
                                            placeholder="Input Nama" />
                                    </td>
                                    <td class="py-1 px-6">
                                        <input v-model="memberResponsiple.role_pc" type="text"
                                            class="text-center w-full pl-3 py-2 bg-white placeholder-slate-400 rounded-md sm:text-sm"
                    ...
                    <div class="flex justify-between items-end mt-4 px-6 mb-4">
                        ...
                        <button @click="submit_roleresponse(); submit_detailresponse(); nextStep()"
                            class="ml-auto px-10 h-10 text-sm bg-[#C53030] text-white rounded-md">
                            Next
                        </button>
                ...
                <div v-if="currentStep === 6">
                    <div class="mb-1 flex flex-col px-6 pt-4">
                            ...
                            <div class="flex flex-col lg:w-full">
                                <div class="">
                                    <label class="block text-md font-medium pt-6 text-slate-700">
                                        Project Manager’s Responsibility <span
                                            class=" text-xs text-gray-500">(required)</span>
                                    </label>
                                    <textarea name="descriptions" v-model="postData.pm_responsibility"
                                        class="mt-1 w-full px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm" />
                                </div>
                                <div class="">
                                    <label class="block text-md font-medium pt-2 text-slate-700">
                                    ...
                                    <div class="flex items-center">
                                        <div class="relative w-full">
                                            ...
                                            <input type="boolean" name="project-value" pattern="[0-9]*"
                                                v-model="postData.project_value"
                                ...
                                <div class="">
                                    ...
                                    <input type="date" name="start-date" v-model="postData.start_date"
                                        class="mt-1 w-full px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm "
                                ...
                                <div class="">
                                    ...
                                    <input type="date" name="end-date" v-model="postData.end_date"
                                        class="mt-1 w-full px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm "
                        ...
                        <div class="flex justify-between items-end mt-4 mb-4">
                            ...
                            <button @click="submit_bility(); nextStep()"
                                class="ml-auto px-10 h-10 text-sm bg-[#C53030] text-white rounded-md">
                                Next
                            </button>
                        </div>
                    ...
                    <div class="mb-1 flex flex-col px-6 pt-4">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white border-collapse rounded-md">
                                ...
                                <tbody>
                                    <tr v-for="(supporting, index ) in supporting" :key="supporting.id_charter">
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-4">
                                            <label for="docNameInput"
                                                class="block text-sm font-medium text-gray-700">Document Name</label>
                                            <input type="text" id="docNameInput" v-model="postData.document_name"
                                                placeholder="Enter document name" class="mt-1 p-1 border rounded-md w-full">
                                        </div>

                                        <!-- Input untuk note -->
                                        <div class="mb-4">
                                            <label for="noteInput" class="block text-sm font-medium text-gray-700">Note
                                            </label>
                                            <textarea id="noteInput" placeholder="Enter notes" v-model="postData.notes"
                                                class="mt-1 p-1 border rounded-md w-full"></textarea>
                                        </div>

                                        <!-- Tombol untuk menyimpan -->
                                        <button @click="submit_supportingdocument()"
                ...
                <div v-if="currentStep === 8">
                    <div class="mb-1 flex flex-col-reverse sm:flex-col px-6 pt-4">
                        ...
                        <div class="flex flex-col lg:flex-row space-x-8">
                            <div class="flex flex-col lg:w-full">
                                <div class="">
                                    ...
                                    <textarea name="descriptions" v-model="postData.note"
                                        class="mt-1 w-full px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 rounded-md sm:text-sm" />
                                </div>
                                <div>
                                    <label class="block text-md font-medium text-slate-700">
                                ...
                                <div class="flex flex-col lg:flex-row">
                                    <div class="flex flex-col lg:w-full">
                                        <label class="block text-md font-medium text-slate-700">
                                            Name :
                                            <input type="text" style="border: none;" v-model="postData.nama"
                                                class="bg-white placeholder-slate-400 rounded-md sm:text-sm px-3 py-2 my-1">
                                        </label>
                                        <hr>
                                        <label class="block text-md font-medium text-slate-700">
                                            Title :
                                            <input type="text" style="border: none;" v-model="postData.title"
                                                class="bg-white placeholder-slate-400 rounded-md sm:text-sm px-3 py-2 my-1">
                                        </label>
                                        <hr>
                                        <label class="block text-md font-medium text-slate-700">
                                            CC To :
                                            <input type="text" style="border: none;" v-model="postData.cc_to"
                                                class="bg-white placeholder-slate-400 rounded-md sm:text-sm px-3 py-2 my-1">
                                        </label>
                                        <hr>
                                        <label class="block text-md font-medium text-slate-700">
                                            Date :
                                            <input type="date" style="border: none;" v-model="postData.date"
                                                class="bg-white placeholder-slate-400 rounded-md sm:text-sm px-3 py-2 my-1">
                                        </label>
                                        <hr>
                                    </div>
                                    <div class="flex flex-col lg:w-full">
                                        <label class="block text-md font-medium text-slate-700">
                                            Name :
                                            <input type="text" style="border: none;" v-model="postData.nama1"
                                                class="bg-white placeholder-slate-400 rounded-md sm:text-sm px-3 py-2 my-1">
                                        </label>
                                        <hr>
                                        <label class="block text-md font-medium text-slate-700">
                                            Title :
                                            <input type="text" style="border: none;" v-model="postData.title1"
                                                class="bg-white placeholder-slate-400 rounded-md sm:text-sm px-3 py-2 my-1">
                                        </label>
                                        <hr>
                                        <label class="block text-md font-medium text-slate-700">
                                            CC To :
                                            <input type="text" style="border: none;" v-model="postData.cc_to1"
                                                class="bg-white placeholder-slate-400 rounded-md sm:text-sm px-3 py-2 my-1">
                                        </label>
                                        <hr>
                                        <label class="block text-md font-medium text-slate-700">
                                            Date :
                                            <input type="date" style="border: none;" v-model="postData.date1"
                                                class="bg-white placeholder-slate-400 rounded-md sm:text-sm px-3 py-2 my-1">
                                        </label>
                                        <hr>
                            ...
                            <div class="lg:w-1/3 px-4">
                                <!-- Tambahkan gambar Anda di sini -->
                                <img src="/assets/img_charter2.svg" alt="Your Image" class="w-full h-auto">
                            </div>
                        ...
                        <div class="flex justify-between items-end mt-4 mb-4">
                            ...
                            <button @click="submit_approvedby(); nextStep()"
                                class="ml-auto px-10 h-10 text-sm bg-[#C53030] text-white rounded-md">
                                Submit
                            </button>
                        </div>
...
export default {
    data() {
        return {
            ...
            axiosInstance: axios.create({
                baseURL: 'https://z8v4553q-8000.asse.devtunnels.ms/api/projectcharter',
            }),
    ...
    methods: {
        handleHighLevelRequirmentChange(event) {
            const file = event.target.files[0];
            this.postData.hlr = file; // Menggunakan hld sesuai properti yang digunakan
        },

        handleFileInputChange(event) {
            const file = event.target.files[0];
            this.postData.struktur_organisasi = file; // Menggunakan hld sesuai properti yang digunakan
        },

        // handleFileChange(event) {
        //     const file = event.target.files[0];
        //     this.postData.document = file;
        // },

        handleFileChange(event) {
            this.postData.document = event.target.files[0];
        },

        fetchSupportingDocuments() {
            let token = localStorage.getItem('token')

            this.axiosInstance.get("https://z8v4553q-8000.asse.devtunnels.ms/api/supporting/", {
                headers: {
        ...
        //page 1
        submit_projectcharter() {
            const formData = new FormData();
            formData.append('project_name', this.postData.project_name);
            formData.append('project_manager', this.postData.project_manager);
            formData.append('customer', this.postData.customer);
            formData.append('end_customer', this.postData.end_customer);
            formData.append('bu_delivery', this.postData.bu_delivery);
            formData.append('bu_related', this.postData.bu_related);
            formData.append('project_description', this.postData.project_description);
            ...
            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/projectcharter/', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'Authorization': `Bearer ${token}`
                    },
                ...
                .then((res) => {
                    ...
                    localStorage.setItem('id_charter', res.data.id_charter);
                })
                .catch((err) => {
        ...
        submit_description() {
            const formData = new FormData();
            formData.append('hlr', this.postData.hlr);
            formData.append('assumptions', this.postData.assumptions);
            formData.append('contraints', this.postData.contraints);  // Pastikan ini sesuai dengan format yang diharapkan oleh Django
            formData.append('risk', this.postData.risk);      // Pastikan ini sesuai dengan format yang diharapkan oleh Django
            formData.append('key_stakeholders', this.postData.key_stakeholders);
            formData.append('status_description', this.postData.status_description);
            formData.append('id_user', this.user_data.id_user);
            formData.append('id_charter', localStorage.getItem('id_charter'));
            ...
            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/description/', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'Authorization': `Bearer ${token}`
                    },
        ...
        submit_deliverable() {
            ...
            // Mengambil nilai deliverables dari komponen atau sumber data lainnya
            const deliverablesData = this.deliverables.map(deliverable => ({
                deliverables: deliverable.value,  // Pastikan menggunakan deliverable.value
                id_charter: localStorage.getItem('id_charter'),
                id_user: this.user_data.id_user,
                // project_name: this.postData.project_name,  // Sesuaikan dengan kebutuhan
            }));

            console.log('Mengirimkan data:', deliverablesData);

            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/deliverable/', deliverablesData, {
                    headers: {
        ...
        submit_milestone() {
            ...
            const ArrayData = this.milestones.map(milestone => ({
                // role: mainpower.role.toUpperCase(),  // Pastikan penulisan yang benar
                milestone: milestone.milestone,
                deskripsi: milestone.description,
                tanggal: milestone.date,
                id_user: this.user_data.id_user,
                id_charter: localStorage.getItem('id_charter'),
            }));
            ...
            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/milostones/', ArrayData, {
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
                    },
        ...
        submit_roleresponse() {
            const formData = new FormData();
            formData.append('struktur_organisasi', this.postData.struktur_organisasi);
            formData.append('id_user', this.user_data.id_user);
            formData.append('id_charter', localStorage.getItem('id_charter'));
            ...
            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/rolerespon/', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'Authorization': `Bearer ${token}`
                    },
                ...
                .then((res) => {
                    console.log('POST berhasil:', res);
                    localStorage.setItem('id_responsibilities', res.data.id_responsibilities);
                })
                .catch((err) => {
                    console.error('POST error:', err);
        ...
        //page 5
        submit_detailresponse() {
            let token = localStorage.getItem('token');
            console.log(token);

            // console.log(this.memberResponsiples);

            const ArrayData = this.membersResponsiple.map(memberResponsiple => ({
                nama_pc: memberResponsiple.nama_pc,
                role_pc: memberResponsiple.role_pc,
                description: memberResponsiple.description,
                id_responsibilities: localStorage.getItem('id_responsibilities'),
                id_user: this.user_data.id_user,
                id_charter: localStorage.getItem('id_charter'),
            }));
            ...
            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/detailrespon/', ArrayData, {
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
                    },
        ...
        submit_bility() {
            const formData = new FormData();
            formData.append('pm_responsibility', this.postData.pm_responsibility);
            formData.append('project_value', this.postData.project_value);
            formData.append('start_date', this.postData.start_date);
            formData.append('end_date', this.postData.end_date);
            formData.append('project_description', this.postData.project_description);
            formData.append('id_user', this.user_data.id_user);
            formData.append('id_charter', localStorage.getItem('id_charter'));
            formData.append('project_name', this.postData.project_name);
            ...
            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/bility/', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'Authorization': `Bearer ${token}`
                    },
        ...
        //page 7
        submit_supportingdocument() {
            const formData = new FormData();
            formData.append('document_name', this.postData.document_name);
            formData.append('notes', this.postData.notes);
            formData.append('document', this.postData.document);
            formData.append('id_user', this.user_data.id_user);
            formData.append('id_charter', localStorage.getItem('id_charter'));
            ...
            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/supporting/', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'Authorization': `Bearer ${token}`
                    },
                ...
                .then((res) => {
                    console.log('POST berhasil:', res);
                    window.alert('Document successfully added.');
                    this.closeAddDocModal();

                    this.fetchSupportingDocuments();
                })
                .catch((err) => {
                    console.error('POST error:', err);
                    ...
                    window.alert('Failed to add document. Please try again.');
                });
        },
        ...
        submit_approvedby() {
            ...
            formData.append('nama', this.postData.nama);
            formData.append('cc_to', this.postData.cc_to);
            formData.append('tanggal', formatDate(this.postData.tanggal));
            formData.append('title', this.postData.title);
            formData.append('nama1', this.postData.nama1);
            formData.append('cc_to1', this.postData.cc_to1);
            formData.append('tanggal1', formatDate(this.postData.tanggal1));
            formData.append('title1', this.postData.title1);
            formData.append('id_user', this.user_data.id_user);
            formData.append('id_charter', localStorage.getItem('id_charter'));
            // formData.append('project_name', this.postData.project_name);
            ...
            this.axiosInstance
                .post('https://z8v4553q-8000.asse.devtunnels.ms/api/approved/', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'Authorization': `Bearer ${token}`
                    },
